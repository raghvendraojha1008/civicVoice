...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "CivicVoice — Report and track civic issues" },
      { name: "description", content: "Report potholes, water leaks, broken streetlights and more. Track resolution in real time on a public map." },
      { name: "author", content: "CivicVoice" },
      { property: "og:title", content: "CivicVoice — Report and track civic issues" },
      { property: "og:description", content: "Report potholes, water leaks, broken streetlights and more. Track resolution in real time on a public map." },
